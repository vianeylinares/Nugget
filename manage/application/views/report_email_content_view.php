			...
			?>
				<table class = "myOtherTable">
						...
						<tr class = "table-title">
							<td>Nombre</td><td>Telefono</td><td>Email</td><td>Fecha</td><td>Mensaje</td><td>MailChimp</td>
						</tr>
						...
						<tr>
							...
							foreach ($business as $row) {
									...
									<td><?php echo $name; ?></td><td><?php echo $phone; ?></td><td><?php echo $email; ?></td><td><?php echo $date; ?></td><td><?php echo $message; ?></td><td><?php echo $mailchimp; ?></td>
